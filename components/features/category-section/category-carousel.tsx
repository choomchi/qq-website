...
export default function CategoryCarousel({
  ...
  const subtleText =
    bg === "default" ? "text-muted-foreground" : "text-white/60";
  const arrowBorder =
    bg === "default"
  ...
  return (
    <section className={`w-full ${bgClasses[bg]}`} dir="rtl">
      <div className="mx-auto w-full max-w-7xl px-4 pt-6 pb-4">
        ...
        <div
          className={`mb-3 h-px w-full ${bg === "default" ? "bg-border" : "bg-white/20"}`}
        />
        ...
        >
          {products.map((product) => (
            <div
              ...
              className="w-[140px] md:w-[180px] lg:w-[calc(18%-10px)] shrink-0 lg:min-w-40"
            >
              {cardVariant === "detail" ? (
